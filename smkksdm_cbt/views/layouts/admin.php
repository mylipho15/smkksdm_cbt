...
<head>
    ...
    <title><?= isset($pageTitle) ? $pageTitle : 'Dashboard' ?> - Admin Exam CBT</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .role-guru { background: #28a745; color: white; }
        .role-siswa { background: #17a2b8; color: white; }
...
<body>
    <nav class="navbar">
        ...
        <div class="navbar-right">
            <div class="user-info">Halo, <?= htmlspecialchars($user['nama_lengkap']) ?></div>
